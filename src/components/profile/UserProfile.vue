<template>
  <n-grid x-gap="12" :cols="3">
    <n-gi>
      <n-card title="Personal" style="max-width: 300px; margin: 20 auto;">
          <div>
    ...
    <n-gi>
      <n-card title="Kontak" style="max-width: 300px; margin: 0 auto;">
          <div>
    ...
    <n-gi>
      <n-card title="Kepegawaian" style="max-width: 300px; margin: 0 auto;">
          <div>
    ...
    <n-gi>
      <n-card title="Pelatihan" style="max-width: 300px; margin: 0 auto;">
          <div>
