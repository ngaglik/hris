<template>
  <n-scrollbar x-scrollable style="max-width: 100%;">
    <n-grid x-gap="12" :cols="4" style="min-width: 1200px;">
      <n-gi>
        <n-card title="Personal" style="max-width: 300px; margin: 0 auto;" hoverable>
            <div>
      ...
      <n-gi>
        <n-card title="Kontak" style="max-width: 300px; margin: 0 auto;" hoverable>
            <div>
      ...
      <n-gi>
        <n-card title="Kepegawaian" style="max-width: 300px; margin: 0 auto;" hoverable>
            <div>
      ...
      <n-gi>
        <n-card title="Pelatihan" style="max-width: 300px; margin: 0 auto;" hoverable>
            <div>
  ...
  <n-card title="Riwayat Pendidikan" style="max-width: 100%; margin: 0 auto;" hoverable>
        <div>
          <Education :employeeId="empId" :personId="persId"/>{{empId}} | {{persId}}
        </div>
      </n-card>
</template>
