        ...
        <n-form :model="formData" label-width="100">
            ...
            <n-form-item label="Status Perkawinan (Gaji)">
                ...
                <n-popover trigger="hover" raw :show-arrow="false">
                    ...
                    >
                        ...
                        Anak kandung/angkat yang belum menikah, belum memiliki
                        penghasilan sendiri, berusia dibawah 21 tahun, atau bisa
                        diperpanjang hingga 25 tahun jika masih
                        sekolah/kuliah/kursus, dengan syarat nyata menjadi
                        tanggunan PNS, diberikan maksimal 3 anak, dan besarnya
                        2% dari gaji pokok per anak
                    </div>
                </n-popover>
            </n-form-item>
            <n-divider title-placement="left"> Perpajakan </n-divider>
            ...
            <n-form-item label="Status Perkawinan (SPT)">
                ...
                <n-popover trigger="hover" raw :show-arrow="false">
                    ...
                    >
                        Ketentuan tanggungan anak : <br />
                        Anak kandung atau anak angkat yang sepenuhnya berada
                        dibawah tanggungan, dengan batasan maksimal 3 anak per
                        keluarga. Status anak tersebut harus dalam kondisi belum
                        menikah dan belum memiliki penghasilan sendiri.
                    </div>
                </n-popover>
            </n-form-item>
        </n-form>
